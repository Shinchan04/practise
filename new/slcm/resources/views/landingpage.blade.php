...
<!--Start Contact Page-->
<section class="loanform" style="background-image: url(assets/images/backgrounds/48hoursloan-SLCM.png);  background-size:cover; padding:90px; ">
        <div class="container">
            <div class="row">
                <!--Start Contact Page Left-->
                <div class="col-xl-8 col-lg-8" id="cio">
                ...
                <!--Start Contact Page Right-->
                  <div class="col-xl-4 col-lg-4" style="padding-top:60px;  background: rgb(103,114,110);
background: linear-gradient(113deg, rgba(103,114,110,1) 25%, rgba(104,121,115,1) 66%, rgba(80,135,100,1) 85%); padding-top:30px; padding-bottom-30px; border-radius:15px;">
                    ...
                    <div class="contact-page__right">
                        <form action="{{ url('contact.html') }}" class="comment-one__form contact-form-validated"
                            ...
                            <!-- <div class="col-xl-6 col-lg-6"> -->
                                    <div class="comment-form__input-box">
                                        <select name="Existing Business" placeholder="Existing Business" class="ignore" required>
                                            <option value="" selected disabled>Existing Business</option>
                                    ...
                                    <!-- <div class="col-xl-6 col-lg-6"> -->
                                    <div class="comment-form__input-box">
                                        <select name="State" class="ignore" required>
                                    ...
                                    <!-- <div class="col-xl-6 col-lg-6"> -->
                                    <div class="comment-form__input-box">
                                        <select name="City" class="ignore" required>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
        ...
        <a href="https://kissandhan.com/cbf.html">
          <div class="services-one__single-img" >
            <div class="services-one__single-img-inner" >
              <img loading="lazy" src="assets/images/landingpage/new/cbf.png" alt=""  />
            </div>
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/cbf.html">Commodity Based Financing <br>(CBF)</a></h3>
            <p>Commodity Based Financing (CBF) is a unique product offered by Kissandhan.</br> The basic principle of financing is the underlying asset/ commodity which is being taken as collateral. </p>
              <a href="https://kissandhan.com/cbf.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
          </a>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1000ms">
        <div class="services-one__single">
        <a href="https://kissandhan.com/nbfc.html">
          <div class="services-one__single-img">
            <div class="services-one__single-img-inner" >
              <img loading="lazy" src="assets/images/landingpage/new/nbfc.png" alt="" />
            </div>
            <div class="services-one__single-img-icon">
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/nbfc.html">Lending to NBFC-MFI </br> for on-Lending Purpose </a></h3>
            ...
            <a href="https://kissandhan.com/nbfc.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
  </a>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1000ms">
        <div class="services-one__single">
        <a href="https://kissandhan.com/bc-partnership-lending.html">
          <div class="services-one__single-img">
            <div class="services-one__single-img-inner" >
              <img loading="lazy" src="assets/images/landingpage/new/partnership.png" alt="" />
            </div>
            <div class="services-one__single-img-icon">
              <span class="icon-investment"></span>
            </div>
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/bc-partnership-lending.html">Business Correspondent (BC) <br>Partnership-Lending</a></h3>
            ...
            <a href="https://kissandhan.com/bc-partnership-lending.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
        </a>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">
        <div class="services-one__single">
        <a href="https://kissandhan.com/fpo.html">
          <div class="services-one__single-img" >
            <div class="services-one__single-img-inner">
              <img loading="lazy" src="assets/images/landingpage/new/farmer-producer.png" alt="" />
            </div>
            <div class="services-one__single-img-icon">
              <span class="icon-farm"></span>
            </div>
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/fpo.html">Lending To Farmer Producer<br>Organisation (FPOS) </a></h3>
            <p>Farmer Producer Organization (FPO), is a legal entity formed by primary producer with common interest.<br>
            It is established in the form of Producer Company, a Cooperative Society or any other legal entity that provides systems and processes for profit sharing and benefits among the members.          
          </p>
            <a href="https://kissandhan.com/fpo.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
  </a>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">
        <div class="services-one__single">
        <a href="https://kissandhan.com/invoice-discounting-facility.html">
          <div class="services-one__single-img">
            <div class="services-one__single-img-inner" >
              <img loading="lazy" src="assets/images/landingpage/new/invoice.png" alt="" />
            </div>
            <div class="services-one__single-img-icon">
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/invoice-discounting-facility.html">Invoice Discounting Facility</a></h3>
            ...
            <a href="https://kissandhan.com/invoice-discounting-facility.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
  </a>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1000ms">
        <div class="services-one__single">
        <a href="https://kissandhan.com/other-products.html">
          <div class="services-one__single-img">
            <div class="services-one__single-img-inner" >
              <img loading="lazy" src="assets/images/landingpage/new/other.png"  alt="" />
            </div>
            <div class="services-one__single-img-icon">
          ...
          <div class="services-one__single-content text-center">
            <h3><a href="https://kissandhan.com/other-products.html">Other Products</a></h3>
            <p>Some more products like Term Loan/OD facility to Agri Enterprises/MSME like Agri Processors/Artias/Traders, lending for Farm Mechanisation, Impact Lending, and Loan facility for Input Dealers, etc. are in process which will be introduced shortly.</p>
            <a href="https://kissandhan.com/other-products.html" class="read-more-btn"><span class="icon-right-arrow-2"></span></a>
          </div>
  </a>
        </div>
      </div>
...
<div class="row">
  ...
  <div class="p-2">Flex item 3</div>
      ...
      <div class="col-4 col-sm-6">
        ...
        <ul>
        <li>
          <img src="/assets/images/landingpage/1.png">
          <h6> Competent Professionals </h6>
</li>
<li>
          <img src="/assets/images/landingpage/2.png">
          <h6> Superior Service </h6>
</li>
<li>
          <img src="/assets/images/landingpage/3.png">
