...
@section('content')
<!--Page Header Start-->
<section class="page-header clearfix innerPage_header" style="background-image: url(assets/images/backgrounds/contact2.jpg);">
            <div class="container">
                <div class="page-header__inner">
                <div class="btn-group language_switcher">
                    <a href="{{url('slcm-contact.html')}}" class="btn thm-btn" aria-current="page">English</a>
                    <a href="{{url('myan-slcm-contact.html')}}" class="btn thm-btn active">Burmese</a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="contact-page__left">
                    ...
                    <p class="contact-page__left-text mt-20">
                        ...
                        SLCM LIMITED MYANMAR,
                        ROOM NO. 509 - LEVEL 5,
                        LA PYAYT WUN PLAZA,
                        NEXT TO HOTEL PARK ROYAL YANGON,
                        ALAN PYA PAGODA ROAD,
                        DAGON TOWNSHIP, YANGON REGION, MYANMAR<br />
                        TEL : +95 9254414683</p>
